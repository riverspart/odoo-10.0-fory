...
class StockMove(models.Model):
    ...
    def _prepare_account_move_line(self, qty, cost, credit_account_id, debit_account_id):
        ...
        debit_line_vals['date'] = self.temp_posted_date
        if(purchase_order):
            amount_currency =  purchase_order.currency_id.round(self.price_unit_before * qty)
            debit_line_vals['amount_currency'] = amount_currency
            debit_line_vals['currency_id'] = purchase_order.currency_id.id
        # tungnt end
        ...
        # tungnt start
        credit_line_vals['date'] = self.temp_posted_date
        if (purchase_order):
            credit_line_vals['amount_currency'] = - amount_currency
            credit_line_vals['currency_id'] = purchase_order.currency_id.id
        # tungnt end
